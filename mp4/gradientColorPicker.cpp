...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
     ...
     */
     ...
     if(distance > radius_1)
      ...
      {
        color.red = fadeColor_1.red - floor(distance*fadeColor_1.red/radius_1) + floor(distance*fadeColor_2.red/radius_1);
      	color.green = fadeColor_1.green - floor(distance*fadeColor_1.green/radius_1) + floor(distance*fadeColor_2.green/radius_1);
      	color.blue = fadeColor_1.blue - floor(distance*fadeColor_1.blue/radius_1) + floor(distance*fadeColor_2.blue/radius_1);
        return color;
      }
